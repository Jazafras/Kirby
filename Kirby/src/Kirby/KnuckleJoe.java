...
import jig.Vector;
 ...
 class KnuckleJoe extends MovingEnemy {
		public static final String[] facingImages = 
			{
				KirbyGame.KNUCKLE_RIGHT,
				KirbyGame.KNUCKLE_LEFT

			};
		
		public static final String[] attackingImages = 
			{
				KirbyGame.KNUCKLE_ATTACK_R,
				KirbyGame.KNUCKLE_ATTACK_L
	...
	public KnuckleJoe(final float x, final float y) {
	...
	public void render(Graphics g, float offsetX, float offsetY) throws SlickException {
		...
		if (attackState){
			...
			i.draw(super.getX() - 40 - offsetX, super.getY() + 8 - offsetY);
		}
		else{
			i = new Image(facingImages[super.getFacing()]);
			i.draw(super.getX() - 4 - offsetX, super.getY() + 8 - offsetY);
		}
	}
